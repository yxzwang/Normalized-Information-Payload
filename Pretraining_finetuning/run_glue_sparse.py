...
from pretraining.sparse_modeling import BertForSequenceClassification
...
def main():
    ...
    if data_args.task_name is not None:
        ...
        if not is_regression:
            if "train" in datasets.keys():
                ...
                label_list = datasets["test"].features["label"].names
    ...
    if training_args.do_predict:
        ...
        for test_dataset, task in zip(test_datasets, tasks):
            ...
            print(f"test_results_file_name: {output_test_file}")
