...
def train(
    ...
    try:
        ...
        dataset_iterator, total_length = pretrain_dataset_provider.get_shard(index+1)
...
def prepare_model_and_optimizer(args):
    ...
    model.network = BertLMHeadModel.from_pretrained("bert80k-consine/pretraining_experiment-/epoch1000000_step80030")
